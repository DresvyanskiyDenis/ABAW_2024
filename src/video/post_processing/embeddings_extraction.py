...
def main():
    ...
    config_face_extraction_b1_exp = {
        ...
        'path_to_weights': "/nfs/scratch/Data/weights_best_models/ABAW/fine_tuned/Exp_challenge/AffWild2_static_exp_best_B1.pth",
        'num_classes': 8,
        'num_regression_neurons': 2,
        'output_path_train': "/nfs/scratch/Data/preprocessed/extracted_features/Exp_challenge/EfficientNet_b1/b1_facial_features_train.csv",
        'output_path_dev': "/nfs/scratch/Data/preprocessed/extracted_features/Exp_challenge/EfficientNet_b1/b1_facial_features_dev.csv",
    }
    ...
    config_face_extraction_ViT_exp = {
        ...
        'path_to_data': "/nfs/scratch/Data/preprocessed/faces/",
        'model_type': 'ViT_b_16',
        'path_to_weights': "/nfs/scratch/Data/weights_best_models/ABAW/fine_tuned/Exp_challenge/AffWilf2_static_exp_best_ViT.pth",
        'num_classes': 8,
        'num_regression_neurons': 2,
        'output_path_train': "/nfs/scratch/Data/preprocessed/extracted_features/Exp_challenge/ViT_b_16/ViT_b_16_facial_features_train.csv",
        'output_path_dev': "/nfs/scratch/Data/preprocessed/extracted_features/Exp_challenge/ViT_b_16/ViT_b_16_facial_features_dev.csv",
    }
    ...
    config_pose_extraction_HRNet = {
        ...
        'Exp_train_labels_path': '/nfs/scratch/Data/6th ABAW Annotations/EXPR_Recognition_Challenge/Train_Set/',
        'Exp_dev_labels_path': '/nfs/scratch/Data/6th ABAW Annotations/EXPR_Recognition_Challenge/Validation_Set/',
        'metafile_path': "/nfs/scratch/Data/preprocessed/pose/metadata.csv",
        'va_train_labels_path': None,
        'va_dev_labels_path': None,
        'labels_columns': ['timestamp', 'frame_num']+[f"category_{i}" for i in range(8)],
        'path_to_data': "/nfs/scratch/Data/preprocessed/pose/",
        'model_type': 'HRNet',
        'path_hrnet_weights': "/nfs/scripts/simple-HRNet-master/pose_hrnet_w32_256x192.pth",
        'path_to_weights': "/nfs/scratch/Data/weights_best_models/ABAW/fine_tuned/Exp_challenge/AffWild2_static_exp_best_HRNet.pth",
        'num_classes': 8,
        'num_regression_neurons': 2,
        'output_path_train': "/nfs/scratch/Data/preprocessed/extracted_features/Exp_challenge/HRNet/HRNet_kinesics_features_train.csv",
        'output_path_dev': "/nfs/scratch/Data/preprocessed/extracted_features/Exp_challenge/HRNet/HRNet_kinesics_features_dev.csv",
    }
    ...
    config_face_extraction_b1_VA = {
        ...
        'path_to_data': "/nfs/scratch/Data/preprocessed/face/",
        'labels_columns': ['timestamp', 'frame_num']+['arousal', 'valence'],
        'model_type': 'EfficientNet-B1',
        'path_to_weights': "/nfs/scratch/Data/weights_best_models/ABAW/fine_tuned/VA_challenge/AffWild2_static_va_best_b1.pth",
        'num_classes': 8,
        'num_regression_neurons':2,
        'output_path_train': "/nfs/scratch/Data/preprocessed/extracted_features/VA_challenge/EfficientNet_b1/b1_facial_features_train.csv",
        'output_path_dev': "/nfs/scratch/Data/preprocessed/extracted_features/VA_challenge/EfficientNet_b1/b1_facial_features_dev.csv",
    }
    ...
    config_face_extraction_b4_VA = {
        ...
        'path_to_weights': "/nfs/scratch/Data/weights_best_models/ABAW/fine_tuned/VA_challenge/AffWild2_static_va_best_b4.pth",
        'num_classes': 8,
        'num_regression_neurons':2,
        'output_path_train': "/nfs/scratch/Data/preprocessed/extracted_features/VA_challenge/EfficientNet_b4/b4_facial_features_train.csv",
        'output_path_dev': "/nfs/scratch/Data/preprocessed/extracted_features/VA_challenge/EfficientNet_b4/b4_facial_features_dev.csv",
    }
    ...
    config_face_extraction_HRNet_VA = {
        ...
        'model_type': 'HRNet',
        'path_hrnet_weights': "/nfs/scripts/simple-HRNet-master/pose_hrnet_w32_256x192.pth",
        'path_to_weights': "/nfs/scratch/Data/weights_best_models/ABAW/fine_tuned/VA_challenge/AffWild2_static_va_best_HRNet.pth",
        'num_classes': 8,
        'num_regression_neurons': 2,
        'output_path_train': "/nfs/scratch/Data/preprocessed/extracted_features/VA_challenge/HRNet/HRNet_facial_features_train.csv",
        'output_path_dev': "/nfs/scratch/Data/preprocessed/extracted_features/VA_challenge/HRNet/HRNet_facial_features_dev.csv",
    }
