...
from fusion.weighted_fusion.submission_2.submission_2 import load_test_sample_file_and_preprocess, load_labels, \
...
def main():
    ...
    generate_test_predictions(audio=audio_test, video=video_test, statistical=statistical_test,
                              ...
                              output_path="/home/ddresvya/Data/test_set/Exp/submission_3/submission_3.csv")
    # save best weights and threshold
    with open("/home/ddresvya/Data/test_set/Exp/submission_3/best_weights_and_threshold.pickle", "wb") as f:
